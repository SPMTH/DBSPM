...
#mpirun -n 1 ../dbspm fullprep -i input.in --dft-cmd="mpirun -np 32 vasp_std" > test.out
#mpirun -n 32 ../dbspm dens -i input.in > dens.out
#mpirun -n 32 ../dbspm vdw -i input.in > vdw.out
#mpirun -n 32 ../dbspm relax -i input.in > relax.out
#mpirun -n 1 ../dbspm stm -i input.in -b 1.5 > stm.out
mpirun -n 1 ../dbspm brstm -i input.in -b 1.5 > brstm.out